 ...
 * 
 */
public class Bottomtab5Activity extends FragmentActivity implements
		OnClickListener {
	...
	private void initUI() {
		...
		// 找到布局
		bottomtab_rl_one = (RelativeLayout) findViewById(R.id.bottomtab_rl_one);
		bottomtab_rl_two = (RelativeLayout) findViewById(R.id.bottomtab_rl_two);
		bottomtab_rl_thr = (RelativeLayout) findViewById(R.id.bottomtab_rl_thr);
		bottomtab_rl_four = (RelativeLayout) findViewById(R.id.bottomtab_rl_four);
		bottomtab_rl_five = (RelativeLayout) findViewById(R.id.bottomtab_rl_five);
		...
		iv_one = (ImageView) findViewById(R.id.bottomtab_iv_one);
		iv_two = (ImageView) findViewById(R.id.bottomtab_iv_two);
		iv_thr = (ImageView) findViewById(R.id.bottomtab_iv_thr);
		iv_four = (ImageView) findViewById(R.id.bottomtab_iv_four);
		iv_five = (ImageView) findViewById(R.id.bottomtab_iv_five);

		tv_one = (TextView) findViewById(R.id.bottomtab_tv_one);
		tv_two = (TextView) findViewById(R.id.bottomtab_tv_two);
		tv_thr = (TextView) findViewById(R.id.bottomtab_tv_thr);
		tv_four = (TextView) findViewById(R.id.bottomtab_tv_four);
		tv_five = (TextView) findViewById(R.id.bottomtab_tv_five);
	...
	private void initheadfragmentmap() {
		...
		bottomtab_top_tab = findViewById(R.id.bottomtab_top_tab);
	...
	private void initTab() {
		...
		if (!oneFragment.isAdded()) {
			// 提交事务
			getSupportFragmentManager().beginTransaction()
					.add(R.id.bottomtab_content_layout, oneFragment).commit();
